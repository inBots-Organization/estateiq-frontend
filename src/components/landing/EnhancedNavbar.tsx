            ...
            <div className="flex items-center gap-2 lg:gap-3">
              ...
              <Link href="/login" className="hidden lg:block nav-action-reveal">
                <Button
                  variant="ghost"
                  className={cn(
                    "text-sm font-semibold relative group overflow-hidden",
                    "hover:bg-muted/60"
                  )}
                >
        ...
        <div className={cn(
          ...
          <div className="flex flex-col h-full overflow-y-auto">
            ...
            <nav className="flex flex-col p-6 gap-1">
              <span className="text-xs font-bold text-muted-foreground uppercase tracking-widest mb-4 px-4">
            ...
            <div className="flex flex-col gap-3 p-6 mt-auto">
              <Link href="/login" onClick={() => setMobileMenuOpen(false)}>
                <Button
                  variant="outline"
                  className="w-full h-12 text-base font-semibold border-2 hover:bg-muted/40"
                >
                  {t.landing.nav.signIn}
                </Button>
              </Link>
              <Link href="/register" onClick={() => setMobileMenuOpen(false)}>
                <Button className="w-full h-12 text-base font-semibold bg-gradient-to-r from-primary via-emerald-500 to-primary shadow-lg shadow-primary/20">
